                ...
                <div class="app-card-login">
                    <div class="grid">
                        <form action="../connexion.php" method="POST" class="form login">
                            <div class="connecter"> Connexion </div>
                            <div class="form__field">
                                <label for="email"><svg class="icon">
                                        <use xlink:href="#icon-user"></use>
                                    </svg><span class="hidden">Adresse mail</span></label>
                                <input autocomplete="email" id="email" type="text" name="email" class="form__input" placeholder="Adresse mail" required />
                            </div>
                        ...
                        <p class="text--center">
                            ...
                            <a href="sign-in.php">S'inscrire maintenant</a>
                            <svg class="icon">
